 ...
 * and these credentials sign in to a business's books, customers and staff records.
 *
...
export async function breachCount(password) {
    try {
         ...
         * the correct outcome is that a user can still change their password.
         * Blocking every credential change in the business because a
